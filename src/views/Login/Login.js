...
export default{
    ...
    methods : {
        ...
        redirectAfterSuccessfullLogin : function(userId){
    ...
    created(){
        ...
        this.debouncedSendData = debounce( async function(){
            ...
            try {
                ...
                let response = await axios.post( API + "user/login" , this.userData , {withCredentials:true})
                ...
                if( data.success ){
                    ...
                    this.redirectAfterSuccessfullLogin( data.result.id )
